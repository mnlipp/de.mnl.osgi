...
public class ServiceTracker<S, T> implements ServiceTrackerCustomizer<S, T> {
    ...
    public void close() {
        ...
        if (DEBUG) {
            if ((cachedReference == null) && (cachedService == null)) {
                System.out
                    .println("ServiceTracker.close[cached cleared]: " + filter);
            }
        }
    }
    ...
    public ServiceReference<S> getServiceReference() {
        ...
        if (reference != null) {
            if (DEBUG) {
                System.out.println(
                    "ServiceTracker.getServiceReference[cached]: " + filter);
            }
            return reference;
        }
        if (DEBUG) {
    ...
    public T getService() {
        ...
        if (service != null) {
            if (DEBUG) {
                System.out
                    .println("ServiceTracker.getService[cached]: " + filter);
            }
            return service;
        }
        if (DEBUG) {
    ...
    public SortedMap<ServiceReference<S>, T> getTracked() {
        SortedMap<ServiceReference<S>, T> map
